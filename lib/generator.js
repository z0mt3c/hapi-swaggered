...
generator.newModel = function(schema, models) {
    ...
    var modelName = Hoek.reach(schema, '_settings.className') || utils.generateNameFromSchema(schema);
    ...
    var properties = generator.createProperties(schema, models);
